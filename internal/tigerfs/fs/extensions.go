...
// knownExtensions lists all extensions we recognize for stripping.
// Used by StripExtension to identify which suffixes to remove.
var knownExtensions = []string{ExtTxt, ExtJSON, ".xml", ExtBin, ".wkb"}
